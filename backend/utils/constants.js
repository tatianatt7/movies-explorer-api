...
const MESSAGE_ERROR_WRONG_USER_DATA = 'Некорректные данные почты или пароля';
...
const MESSAGE_ERROR_CONFLICT = 'Пользователь уже существует';
